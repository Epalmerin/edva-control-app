      ...
      <div className="max-w-md mx-auto px-5 pt-6">
        <div className="bg-neutral-900 text-white rounded-[32px] p-7 shadow-2xl border border-neutral-800">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-black tracking-tight">Edva</h1>
        ...
        <div className="mt-8 space-y-5">
          <Link href="/promoter/attendance" className="group block">
          ...
          <Link href="/promoter/incidences" className="group block">
            <div className="bg-white rounded-[28px] border border-neutral-200 shadow-lg p-6 transition-all duration-300 group-hover:scale-[1.02] group-hover:shadow-2xl">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-bold text-neutral-900">
          ...
          <Link href="/promoter/supervisor-visits" className="group block">
            <div className="bg-white rounded-[28px] border border-neutral-200 shadow-lg p-6 transition-all duration-300 group-hover:scale-[1.02] group-hover:shadow-2xl">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-bold text-neutral-900">
                ...
                <div className="bg-blue-100 text-blue-600 w-16 h-16 rounded-2xl flex items-center justify-center text-3xl" />
              </div>
            </div>
          </Link>
        </div>
